...
router.post("/", authenticate, authorize('Librarian'),validatePayment, createPayment);
router.put("/:id", authenticate, authorize('Librarian'),validatePayment, updatePayment);
